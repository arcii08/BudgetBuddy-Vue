<template>
    <div class="flex flex-col col-span-full xl:col-span-4 bg-gradient-to-b from-sky-500 to-sky-800 rounded-lg border border-sky-500">
      <header class="px-5 py-4 border-b border-slate-600 flex items-center">
        <h2 class="font-semibold text-white">Tarjetas Activas</h2>
      </header>
      <div class="h-full flex flex-col px-5 py-6">
        ...
        <div class="relative w-full max-w-sm mx-auto bg-slate-800 p-3 rounded-2xl">
          ...
          <EditMenu align="right" class="absolute top-0 right-0 inline-flex">
            <li>
              <router-link class="font-medium text-sm text-slate-600 hover:text-slate-800 flex py-1 px-3" to="#0">Tarjeta 1</router-link>
            </li>
            <li>
              <router-link class="font-medium text-sm text-slate-600 hover:text-slate-800 flex py-1 px-3" to="#0">Tarjeta 2</router-link>
            </li>
            <li>
              <router-link class="font-medium text-sm text-rose-500 hover:text-rose-600 flex py-1 px-3" to="#0">Eliminar</router-link>
            </li>
          </EditMenu>
        </div>
        <!-- Details -->
        <div class="grow flex flex-col justify-center mt-3">
          <div class="text-xs text-slate-200 font-semibold uppercase mb-3">Detalles</div>
          <div class="space-y-2">
            <div>
              <div class="flex justify-between text-sm mb-2">
                <div class="text-slate-300">Límites de pago</div>
            ...
            <div>
              <div class="flex justify-between text-sm mb-2">
                <div class="text-slate-300">Límites de los cajeros automáticos</div>
