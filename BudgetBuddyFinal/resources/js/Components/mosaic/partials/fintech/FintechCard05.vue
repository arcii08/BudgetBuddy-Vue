<template>
    <div class="col-span-full xl:col-span-6 bg-white rounded-lg border border-sky-500">
      <header class="px-5 py-4 border-b border-slate-100">
        <h2 class="font-semibold text-slate-800">Gastos recientes</h2>
      </header>
      <div class="p-3">
            ...
            <thead class="text-xs uppercase text-slate-400 bg-slate-50 rounded-sm">
              <tr>
                <th class="p-2 whitespace-nowrap">
                  <div class="font-semibold text-left">Remitente</div>
                </th>
                <th class="p-2 whitespace-nowrap">
                  <div class="font-semibold text-left">Cuenta</div>
                </th>
                <th class="p-2 whitespace-nowrap">
              ...
              <tr>
                <td class="p-2 whitespace-nowrap">
                  <div class="flex items-center">
                    ...
                    <div class="font-medium text-slate-800">Google Limited ES</div>
                  </div>
                </td>
                <td class="p-2 whitespace-nowrap">
                  <div>N26</div>
        ...
        <div class="text-center border-t border-slate-100 px-2">
          <a class="block text-sm font-medium text-indigo-500 hover:text-indigo-600 pt-4 pb-1" href="/expenses">Ver más -&gt;</a>
        </div>
