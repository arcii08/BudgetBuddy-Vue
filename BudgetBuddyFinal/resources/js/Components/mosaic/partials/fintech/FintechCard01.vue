<template>
    <div class="flex flex-col col-span-full xl:col-span-8 bg-white rounded-lg border border-sky-500">
      <header class="px-5 py-4 border-b border-slate-100 flex items-center">
          <h2 class="font-semibold text-slate-800">Resumen de la cuenta</h2>
      </header>
